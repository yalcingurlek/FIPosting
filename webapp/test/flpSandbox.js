		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comkpmgfidocpost-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkpmgfidocpost-display": {
								"semanticObject": "comkpmgfidocpost",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpmg.fidocpost",
									"url": sap.ui.require.toUrl("com/kpmg/fidocpost")
								}
							}
						}
					}
